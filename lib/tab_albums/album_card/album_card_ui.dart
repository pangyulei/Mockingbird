...
class AlbumCardUI extends StatelessWidget {
  ...
  Widget build(BuildContext ctx) {
    ...
    return BlocProvider(
      create: (ctx) => AlbumCardBloc(_id)..add(const AlbumCardLoadingEvent()),
      child: InkWell(
        onTap: () => ctx.read<AlbumCardBloc>().add(AlbumCardClickEvent(ctx)),
        child: Column(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Builder(
                    builder: (ctx) {
                      final name = ctx.select<AlbumCardBloc, String>(
                  ...
                  Builder(
                    builder: (ctx) {
                      final mediaCount = ctx.select<AlbumCardBloc, int>(
