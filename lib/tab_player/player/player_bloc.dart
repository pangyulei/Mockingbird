  ...
  void _onInit(PlayerInitEvent event, Emitter<PlayerState> emit) async {
    ...
    final newState = await defer<PlayerState>(
      ...
      () async {
        ...
        var progress = metadata.mediaProgressById(mediaId);
        if (progress != null) {
        ...
        metadata.updateMediaProgress(progress);
