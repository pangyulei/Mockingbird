    ...
    return BlocProvider(
      ...
      child: Builder(
        builder: (context) {
          ...
          final playing = context.select<MediaCardBlocType, bool>((bloc) => bloc.state.playing);
          return GestureDetector(
            onTap: () => context.read<MediaCardBlocType>().add(MediaCardClickEvent(context)),
            child: Container(
  ...
  Widget _title() {
    return Builder(
      builder: (context) {
        final theme = Theme.of(context);
        final colorScheme = theme.colorScheme;
        final (name, playing) = context.select<MediaCardBlocType, (String, bool)>(
