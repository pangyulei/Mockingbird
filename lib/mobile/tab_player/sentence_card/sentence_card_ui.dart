...
abstract class SentenceCardBlocType extends Bloc<SentenceCardEvent, SentenceCardState> {
      ...
      child: Padding(
        ...
        child: Builder(
          builder: (context) => InkWell(
            onTap: () => context.read<SentenceCardBlocType>().add(SentenceCardClickEvent(context)),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Builder(
                          builder: (context) {
                            final text = context.select<SentenceCardBlocType, String>(
                              ...
                              builder: (context) {
                                final (period, playing) = context
                                    .select<SentenceCardBlocType, (String, bool)>(
                                      (bloc) => (bloc.state.period, bloc.state.playing),
                                    );
                                return Text(
                                  period,
                                  style: theme.textTheme.labelSmall?.copyWith(
                                    color: playing ? colorScheme.primary : colorScheme.outline,
